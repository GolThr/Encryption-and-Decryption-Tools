...
function desEncrypt(msg, key, modeStr, iv, paddingStr) {
...
function desDecrypt(msg, key, modeStr, iv, paddingStr) {
    var mode = CryptoJS.mode.ECB;
    var padding = CryptoJS.pad.Pkcs7;
    if(modeStr == "ecb"){
        mode = CryptoJS.mode.ECB;
...
$('#encryption').click(function (e) {
    ...
    if(origin == null || origin == ""){
        ...
        var result = desEncrypt(origin, key, mode, iv, padding);
...
$('#decryption').click(function (e) {
    ...
    if(origin == null || origin == ""){
        ...
        var result = desDecrypt(origin, key, mode, iv, padding);
        $('#input_result').val(result);
    }
});
